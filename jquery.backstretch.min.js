...
$container.css({width:rootWidth,height:rootHeight}).find("img:not(.deleteable)").css({width:bgWidth,height:bgHeight}).css(bgCSS);$(window).trigger("backstretch_update",{rootWidth:rootWidth,rootHeight:rootHeight,bgWidth:bgWidth,bgHeight:bgHeight,top:bgCSS.top,left:bgCSS.left});}catch(err){}}};})(jQuery);